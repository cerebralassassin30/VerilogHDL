...
REM
REM Generated by Vivado on Sun May 24 21:41:29 +0530 2026
...
echo "xvlog --incr --relax -prj half_sub_bhmdl_tb_vlog.prj"
call xvlog  --incr --relax -prj half_sub_bhmdl_tb_vlog.prj -log xvlog.log
